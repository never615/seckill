...
CREATE INDEX ON group_buyings (create_time);
...
COMMENT ON COLUMN group_buyings.create_time IS '创建时间';
...
COMMENT ON COLUMN success_group_buyings.create_time IS '创建时间';
